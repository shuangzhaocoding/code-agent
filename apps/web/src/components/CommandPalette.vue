...
const staticCommands = computed<PaletteItem[]>(() => {
  ...
  { id: 'terminal', title: t('commandPalette.openTerminal'), icon: 'terminal', group: t('commandPalette.groupPanel'), keywords: 'tty shell console', run: () => emit('openPanel', 'terminal', 'terminal', t('panels.terminal')) },
  { id: 'terminal-new', title: t('commandPalette.newTerminal'), icon: 'terminal', group: t('commandPalette.groupPanel'), keywords: 'tty shell tab', run: () => window.dispatchEvent(new Event('ca-terminal-shortcut-new')) },
  { id: 'terminal-close-tab', title: t('commandPalette.closeTerminalTab'), icon: 'terminal', group: t('commandPalette.groupPanel'), keywords: 'tty shell close', run: () => window.dispatchEvent(new Event('ca-terminal-close-tab')) },
  ...
  { id: 'debug', title: t('commandPalette.openDebug'), icon: 'bug', group: t('commandPalette.groupPanel'), keywords: 'python debugpy breakpoint', run: () => emit('openPanel', 'debug', 'debug', t('panels.debug')) },
  ...
  { id: 'memory', title: t('commandPalette.openMemory'), icon: 'memory', group: t('commandPalette.groupPanel'), run: () => emit('openPanel', 'memory', 'memory', t('panels.memory')) },
  { id: 'contextDebug', title: t('commandPalette.openContextDebug'), icon: 'eye', group: t('commandPalette.groupPanel'), run: () => emit('openPanel', 'contextDebug', 'contextDebug', t('panels.contextDebug')) },
  { id: 'checkpoints', title: t('commandPalette.openCheckpoints'), icon: 'history', group: t('commandPalette.groupPanel'), run: () => emit('openPanel', 'checkpoints', 'checkpoints', t('panels.checkpoints')) },
